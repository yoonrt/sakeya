...
<script>
	...
	function go_save() {
		...
		if (theForm.kind.value == '') {
			...
			theForm.action = "SakeyaServlet?command=admin_product_write";
			theForm.submit();
		}
	}
	...
	function go_mov() {
		var theForm = document.frm;
		theForm.action = "SakeyaServlet?command=admin_product_list";
		theForm.submit();
	}
	//projectList.jsp
	function go_search() {
	...
	function go_detail(tpage, pseq) {
		...
		theForm.action = "SakeyaServlet?command=admin_product_detail&tpage="
				+ tpage + "&pseq=" + pseq;
	...
	function go_wrt() {
		var theForm = document.frm;
		theForm.action = "SakeyaServlet?command=admin_product_write_form";
		theForm.submit();
	}
	...
	function go_list(tpage) {
		...
		theForm.action = "SakeyaServlet?command=admin_product_list&tpage="
				+ tpage;
		theForm.submit();
	}
	// **************** productDetail.jsp
	function go_mod(tpage, pseq) {
		...
		theForm.action = "SakeyaServlet?command=admin_product_update_form&tpage="
				+ tpage + "&pseq=" + pseq;
		theForm.submit();
	}
	...
	function go_mod_save(tpage, pseq) {
		...
		if (theForm.kind.value == '') {
			...
			if (confirm('수정하시겠습니까?')) {
				...
				theForm.action = "SakeyaServlet?command=admin_product_update";
				theForm.submit();
			}
		}
	}
	...
	function go_mod_mov(tpage, pseq) {
		var theForm = document.frm;
		theForm.action = 'Sakeya?command=admin_product_detail&tpage=' + tpage
				+ "&pseq=" + pseq;
		theForm.submit();
	}
</script>
<c:choose>
	<c:when test="${empty workerId}">
		<script type="text/javascript">
			location.href = 'SakeyaServlet?command=admin_login_form';
		</script>
	</c:when>
</c:choose>
</head>
<body onload="go_ab()">
	<div id="wrap">
		<header>
			<div id="logo">
				<a href="SakeyaServlet?command=admin_login_form"> <img
					src="image/sakeyalogo.png">
				</a>
			</div>
			<input class="btn" type="button" value="logout" style="float: right;"
				onClick="location.href='SakeyaServlet?command=admin_logout'">
		</header>
		<div class="clear"></div>