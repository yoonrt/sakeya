							...
							<ul class="list_snb_sub">
								...
								<c:choose>
									<c:when test="${empty sessionScope.login_Name}">
										<a href="SakeyaServlet?command=qna_list" class="service_a2"
					...
					<div class="_faqListTemplateContainer" id='1'>
						...
						<ul class="list_board">
							<li class="_faqTitle" data-bbsno="122"><a href="#none"
								...
								<div class="cont_faq">사은품은 본품과 별도로 배송되며 본 상품 인수 후 일주일 이내
									택배로 배송됩니다.</div></li>
							<li class="_faqTitle" data-bbsno="123"><a href="#none"
								class="link_cont _faqContents"> <strong class="tit_cont2">상품평 이벤트
										당첨시 사은품 어디로 배송되나요?</strong> <span class="ico_arr">닫기</span>
							</a>
								<div class="cont_faq">
						...
						<ul class="list_board">
							<li class="_faqTitle" data-bbsno="125"><a href="#none"
								class="link_cont _faqContents"> <strong class="tit_cont2">주문한 상품
										못 받았는데 배송 완료로 나와요</strong> <span class="ico_arr">닫기</span>
							</a>
								<div class="cont_faq">
							...
							<li class="_faqTitle" data-bbsno="126"><a href="#none"
								class="link_cont _faqContents"> <strong class="tit_cont2">주문한 상품이 아니고
