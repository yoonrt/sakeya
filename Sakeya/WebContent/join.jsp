...
<body>
    <div class="container">
    <form name="formm" onsubmit="return validate();" method="post" enctype="text/plain" action="SakeyaServlet?command=join">
        <br>
        <table class="table table-bordered table-hover" style="text-align: center; border: 1px solid #dddddd">
            ...
            <tr>
                ...
                <td><input type="text" name="phone" id="phone" size="2" maxlength="10" style="width: 100px;">
<!--                  - </input><input -->
<!--                         type="text" name="phone" id="phone" size="5" maxlength="4"></input> -->
<!--                     - <input type="text" name="phone" id="phone" size="5" maxlength="4"> -->
                </td>
            </tr>
